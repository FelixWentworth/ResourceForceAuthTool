...
angular.module("story").component("storyCharacterSelectionEditor", {
	...
	controller: function controller() {
		...
		ctrl.$onInit = function () {
			ctrl.selectedCharacters.forEach(function (selectedCharacter) {

				Array.removeWhere(ctrl.selectableCharacters, function (c) {
					return c.name == selectedCharacter.name;
				});
...
//# sourceMappingURL=story-character-selection-editor.component.js.map
