...
angular.module("story").component("storyTreeEditor", {
	...
	controller: ["StoryEditorService", "StoryStorageService", function (StoryEditorService, StoryStorageService) {
		...
		ctrl.config.characters.all = [createCharacter("Bob"), createCharacter("Sue"), createCharacter("Mo"), createCharacter("Hannah"), createCharacter("Frank")];
...
//# sourceMappingURL=story-tree-editor.component.js.map
